...
extern int  recv_socket_fd ;
extern S_CanFrame sendframe,recvframe;
extern unsigned int send_frame_id;

extern char CanReState[];

extern int InitCan(void);
